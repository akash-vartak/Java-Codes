...
public class Cube extends Applet implements MouseListener, MouseMotionListener
{
    int width, height;
    int mx, my;  
    Image backbuffer;
    Graphics backg;
    int azimuth = 25, elevation = 30;
    Point3D[] vertices;
    Edge[] edges;
    public void init()
    {
    ...
    public void update( Graphics g )
    {
        ...
        showStatus("(Elevation;Azimuth): ("+elevation+";"+azimuth+") <in degrees>");
    }
